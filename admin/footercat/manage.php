                                ...
                                <div class="row">
                                        ...
                                        if (isset($_GET['disableid'])){
                                           ...
                                           $trust=1;
                                            ...
                                            $stmtUp=$con->prepare("UPDATE tbl_footer_cat SET status=? WHERE footer_cat_id=? AND trust=?");
                                        ...
                                        if (isset($_GET['publicid'])){
                                            ...
                                            $stmtUp1=$con->prepare("UPDATE tbl_footer_cat SET status=? WHERE footer_cat_id=?");
                                        ...
                                        ?>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-hover" id="dataTables-example">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                            $stmt=$con->prepare("SELECT * FROM tbl_footer_cat WHERE trust ='1' ORDER BY orderList ASC");
                                                            $stmt->execute();
                                                            $rows=$stmt->fetchAll();
                                                            $i='';
                                                            foreach ($rows as  $row){
                                                                ...
                                                                if ($row['status']==0){
                                                                    echo "<a  title='Click to public category' href='footercat.php?do=manage&publicid=".$row['footer_cat_id']."' class='btn btn-warning btn-xs'> <i class='fa fa-lock' ></i> Disable</a>";
                                                                }
                                                                echo" </td>";
                                                                echo "</tr>";
                                                            }
